...
_Last verified against codebase: 2026-09-24 (รอบ 190 — 11 ข้อจากเจ้าของ · § ที่ขยับในไฟล์นี้: **§2.2** (โซนผู้ขาย/ผู้ซื้อ ·
วันที่ตรวจกับป้ายบนกระดาษ · สาขาผู้ออกใบ · เล่มที่/เลขที่ · ผู้ติดต่อตามสาขา · local เรียนที่อยู่จาก Azure) · **§3 คำเตือนอนุมัติ**
(`InputVatParkingNotice`) · **§6.2h ใหม่** (ไฟล์แนบบนใบที่อนุมัติแล้ว + ด่านสิทธิ์ · ด่าน §86/4 ใบกำกับซื้อให้เซิร์ฟเวอร์ตัดสิน ·
ผู้ติดต่อหลายสาขา) · รอบ 185–188 ไม่ได้แทนบล็อกนี้ (ประวัติอยู่ใน `CHANGELOG.md`) · ประวัติเต็มรอบ 190 อยู่ใน `CHANGELOG.md`
— commit deda7c9)_
