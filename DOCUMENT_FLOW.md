...
_Last verified against codebase: 2026-09-11 (รอบ 157 — §2.2c ใบรับรองแทนใบเสร็จตัดสินจาก **หลักฐานผู้รับเงิน** (`OcrPayeeEvidence`) ไม่ใช่ "ไม่มีเลขภาษี" · รอบ 156 — **ขั้นตัดสินกลาง "ชุดข้อมูลไหนคือใคร"**
