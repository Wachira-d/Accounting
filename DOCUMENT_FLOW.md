...
| §82/5(6) auto-exclude ใน ภ.พ.30 | `TaxService.IsProhibitedVehicleExpense` | ตัดอัตโนมัติเฉพาะ description ระบุชัดว่า "รถยนต์นั่ง/รถเก๋ง"; คำระบุรถบรรทุก/กระบะ/เครื่องจักร → เคลมได้ไม่ตัด; น้ำมัน/ซ่อมกำกวม (ไม่ระบุชนิดรถ) → **ไม่ตัด** ให้ approval warning สอนกฎ (กระบะตอนเดียว/แค็บ/บรรทุก/ตู้>10 ที่นั่งเคลมได้; เก๋ง/กระบะ 4 ประตูไม่ได้) แล้วผู้ใช้ตัดสินผ่าน IsVatClaimable รายบรรทัด — เดิมคำว่า "ค่าน้ำมัน" คำเดียวโดนตัดทั้งก้อน = ค่าน้ำมันรถกระบะผู้รับเหมาหายจาก ภ.พ.30 (under-claim) |
