...
_· **จุดที่ยังไม่ครอบโดยตั้งใจ**: เส้น integration (`/api/v1` → `SettingsService_
_.GetNextNumberAsync`) ยังเลือกตัวย่อจากชนิดเอกสารล้วน ๆ — คู่ค้าส่งชนิดมาเอง_
_และเอกสารถูกประทับเลขตั้งแต่สร้าง (ไม่ผ่าน approve) จึงยังไม่มีจังหวะตรึงบทบาท;_
_ผลกระทบจำกัดมาก เพราะ integration ส่ง TaxInvoice ที่มี VAT เป็นหลัก ซึ่งได้ TIV_
_อยู่แล้ว. ที่ต้องทำถ้าจะปิดให้ครบ: ห่อ create ด้วย transaction (backlog รอบ 112_
_ข้อ ก) แล้วย้ายการออกเลขไปหลังคำนวณยอด/บทบาท;_
_Last verified against codebase: 2026-09-01 (รอบ 112 — **"เดี๋ยว TIV เดี๋ยว REC":_
