...
_Last verified against codebase: 2026-09-19 (รอบ 183–184 — **ปิด P0 ของ `DECISION_AUDIT_2026-09-18` 21 ข้อ (รอบ 183) แล้วต่อด้วย
7 ทีมผู้เชี่ยวชาญถกเถียงสองฝั่ง (รอบ 184)** · § ที่ขยับในไฟล์นี้: **§2.2** (จุด serialize บรรทัดสแกน · ด่าน `[MATH]` ·
ลูปเรียนรู้ WHT ที่เคยสอนตัวเอง) · **§2.6** (ด่านใบกำกับอย่างย่อ ภ.พ.06 · ใบกำกับเต็มรูปจาก POS · **สูตรคืนเงินที่รวม
ค่าบริการ** ตามคำตัดสินเจ้าของ) · **§3.2** (ขอบเขตด่าน WHT) · **§6.0c-bis** (จับคู่ธนาคาร: `Matched` ต้องมีคู่ · FX ·
