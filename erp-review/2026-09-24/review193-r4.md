...
### R4-1 (P1 · O1) ลายเซ็นลูกค้าเดิมยังอนุมัติเนื้อหาที่แก้แล้วได้ ผ่านเส้น "อนุมัติที่หน้าเอกสาร" ที่ข้อความ 422 แนะนำเอง
...
### R4-2 (P2 · O1) hash เนื้อหาที่ลูกค้าเซ็นไม่ครอบข้อความ/ช่องที่ลูกค้าเห็นหลายช่อง
...
### R4-3 (P2 · L2) migration ย้ายค่าเดิมไม่ใช่ครั้งเดียว — จับแถวที่โค้ดใหม่สร้าง และหักซ้ำเมื่อบูตพร้อมกัน
...
### R4-4 (P2 · C3) `NameMatchKind` ถือ "บจก." · "บมจ." · "หจก." · ไม่มีคำนำหน้า เป็นชื่อเดียวกัน
