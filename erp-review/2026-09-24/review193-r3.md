...
### R3-1 (P1 · L2) ส่วนลดท้ายบิลที่ผู้ใช้กรอกเอง ถูกรวมเข้ากับฐานมัดจำ แล้วตอนอนุมัติถูกรับรู้เป็น "มัดจำ" ทั้งก้อน
...
### R3-2 (P1 · C3) `AdoptTaxId` เขียนเลขภาษีถาวรลงแถวที่จับได้ด้วย **fuzzy/substring**
...
### R3-3 (P1 · O1 N6) ลายเซ็นลูกค้าเดิมถูกใช้อนุมัติใบเสนอราคาที่ถูกแก้เนื้อหาไปแล้ว
...
### R3-4 (P2 · V C-4) ย้าย regex ค่ารับรองออกจาก JS แล้วคำที่เป็นค่ารับรองจริงหลุด (ทิศอันตราย = เคลมภาษีซื้อเกินสิทธิ์)
...
### R3-5 (P2 · L2) ข้อความด่านสั่ง "รับรู้มัดจำที่หน้าเงินมัดจำ" ทั้งที่เส้นที่แนะนำรับรู้ให้อัตโนมัติแล้ว ⇒ รับรู้ซ้ำได้
...
### R3-6 (P2 · L2 N2 + เดิม) idempotency ของ Integration ข้ามใบ Voided แบบไม่มีลำดับ ⇒ สร้างใบกำกับซ้ำ
