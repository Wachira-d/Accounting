...
- **รวมสองค่าที่ความหมายต่างกันไว้ในฟิลด์เดียว — ผู้อ่านปลายทางแยกไม่ออก** (รอบ 193 · ฝ่ายค้านรอบสาม R3-1 · ทีม L2 · **ยังไม่แก้ — รอคำตัดสิน**) —
  ...
  ออกใบกำกับแล้ว (เหมือนกรณี %) · เทสต์สองทิศ: มีส่วนลด → รับรู้เท่าฐานมัดจำเท่านั้น · ไม่มีส่วนลด → 1,869.16 เท่าเดิม
