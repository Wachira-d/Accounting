...
| **3** บัญชี | 🔨 บางส่วน | บัญชี **11340 ลูกหนี้ผู้ให้บริการรับชำระเงิน** ในผังมาตรฐาน · `Helpers/GatewayReconciliation` (บริสุทธิ์ + 7 เทสต์) + `GET pay/reconciliation` — เหลือ JE ตอน confirm/settlement + settlement job + ตัวเลือก WHT บนค่าธรรมเนียม |
