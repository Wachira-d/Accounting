...
public record RealizeDepositRequest(
    ...
    // และเงินประกัน · ใบที่ลักษณะเป็น "ส่วนหนึ่งของราคา" = ราคาเสมอ
    // รอบ 194 M5: **ค่าที่ไม่ว่าง = "นี่คือการริบ"** (ตัวตัดสิน VAT ของการริบ + บัญชีริบของประเภท) · ว่าง = รับรู้ตามปกติ (ส่งมอบ/ให้บริการแล้ว —
    // บัญชีที่ผู้เรียกระบุ · มัดจำเต็มยอดที่ยังไม่เคยเสีย VAT ถูกปฏิเสธพร้อมทางไปต่อ DEPOSIT-PLAIN-REALIZE)
