...
public class Company : BaseEntity
{
    ...
    /// <summary>ได้รับอนุมัติให้ออก **ใบกำกับภาษีอย่างย่อ** (§86/6) หรือยัง
    ///
    /// <para>ต้องเป็น "ผู้ประกอบการค้าปลีก" ที่ยื่น **ภ.พ.06** และได้รับอนุมัติแล้วเท่านั้น ·
    /// ตัวแทนออกแทนไม่ได้ · ธงนี้คือ**เจตนา** ส่วน <see cref="PhoR06ApprovedDate"/> คือ
    /// **หลักฐาน** — ต้องมีทั้งคู่ถึงจะออกได้ (ดู <c>Helpers/PosSlipHeader</c>)</para>
    ///
    /// <para>ที่มา: สลิป POS พิมพ์คำว่า "ใบกำกับภาษีอย่างย่อ" ทุกใบโดยไม่ตรวจอะไรเลย
    /// = ออกใบกำกับโดยไม่มีสิทธิ์ · ผู้ซื้อเคลมภาษีซื้อไม่ได้ตาม §82/5(5)</para></summary>
    public bool IsRetailApproved { get; set; }
    /// <summary>วันที่กรมสรรพากรอนุมัติ ภ.พ.06 — ใบที่ลงวันที่**ก่อน**วันนี้ยังออกอย่างย่อไม่ได้</summary>
    public DateTime? PhoR06ApprovedDate { get; set; }
