...
public class Contact : TenantEntity
{
    ...
    /// <summary>
    /// **บันทึกภายในของผู้ติดต่อ** — ร่องรอยการ sync/ตรวจข้อมูลจากระบบภายนอก
    /// (ชื่อถูกแก้ตามทะเบียน DBD · ค่าที่ต้นทางส่งผิดช่องแล้วถูกปฏิเสธ ฯลฯ)
    ///
    /// <para>⚠️ <b>ภายในเท่านั้น — ห้ามพิมพ์ลงเอกสารที่ส่งให้คู่ค้า</b>
    /// (บทเรียน CLAUDE.md: "ช่องที่ผู้ใช้มองเห็น กับ เก็บไว้ภายใน ห้ามใช้ช่องเดียวกัน"
    /// — เคยเผลอเขียนคำเตือนภายในลง <c>Document.Notes</c> ซึ่ง renderer พิมพ์ลง
    /// กระดาษจริง) · ก่อนใช้ช่องนี้ที่ไหน ให้ <c>grep</c> ก่อนว่า renderer อ่านไหม</para>
    /// </summary>
    public string? InternalNotes { get; set; }
