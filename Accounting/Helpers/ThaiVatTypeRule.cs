...
public static class ThaiVatTypeRule
{
    ...
    public static readonly string[] NotExemptDespiteKeyword =
    {
        ...
        // (นมผง · สูตรทารก · นมถั่วเหลือง · นม UHT) เสีย VAT — ขอบเขต นมสดยกเว้น §81 ยังคงเดิม รอเจ้าของ/นักบัญชีตัดสิน
        ...
        "นมผง", "milk powder", "formula", "นมถั่วเหลือง", "นม uht", "นมยูเอชที",
    };
