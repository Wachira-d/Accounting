    ...
    public static async Task SeedAsync(AccountingDbContext db)
    {
        ...
        var plans = new List<PlanTemplate>
        {
            ...
            new PlanTemplate
            {
                Id = Guid.NewGuid(),
                Name = "ทดลองใช้ฟรี",
                Description = "ทดลองใช้งานระบบบัญชี AcctPlatform ฟรี 14 วัน ไม่ต้องผูกบัตรเครดิต ใช้งานฟีเจอร์พื้นฐานครบถ้วน ออกเอกสาร ดูรายงาน จัดการภาษี ยกเลิกได้ตลอดเวลา",
