...
public static class ChartOfAccountTemplates
{
    ...
    public static List<AccountTemplate> GetCommonAccounts()
    {
        return new List<AccountTemplate>
        {
            ...
            new("11630", "ภาษีซื้อรอเครดิต", "Deferred Input VAT", AccountType.Asset, 4),
            new("11640", "ภาษีซื้อยังไม่ถึงกำหนด", "Input VAT Not Yet Due", AccountType.Asset, 4),
            new("117", "ค่าใช้จ่ายจ่ายล่วงหน้า", "Prepaid Expenses", AccountType.Asset, 3),
            new("11710", "ค่าเช่าจ่ายล่วงหน้า", "Prepaid Rent", AccountType.Asset, 4),
            new("11720", "ค่าเบี้ยประกันจ่ายล่วงหน้า", "Prepaid Insurance", AccountType.Asset, 4),
            new("11730", "ค่าใช้จ่ายจ่ายล่วงหน้าอื่น", "Other Prepaid Expenses", AccountType.Asset, 4),
            new("118", "เงินมัดจำจ่ายล่วงหน้า", "Advance Payments / Deposits Paid", AccountType.Asset, 3),
            new("11810", "เงินมัดจำ", "Deposits Paid", AccountType.Asset, 4),
            new("11820", "เงินจ่ายล่วงหน้าค่าสินค้า/บริการ", "Advance Payments", AccountType.Asset, 4),
            new("119", "สินทรัพย์หมุนเวียนอื่น", "Other Current Assets", AccountType.Asset, 3),
            new("11910", "ภาษีถูกหัก ณ ที่จ่าย", "Withholding Tax Deducted (Receivable)", AccountType.Asset, 4),
            new("11920", "ภาษีเงินได้นิติบุคคลจ่ายล่วงหน้า", "Prepaid Corporate Income Tax", AccountType.Asset, 4),
