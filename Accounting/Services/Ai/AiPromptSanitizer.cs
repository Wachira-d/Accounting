...
public class AiPromptSanitizer : IAiPromptSanitizer
{
    ...
    public string Sanitize(string userPromptJson, bool stripPii)
    {
        ...
        return MaskWithRegex(userPromptJson);
    }

    private static void WalkAndMask(System.Text.Json.Nodes.JsonNode node)
    {
    ...
    private static string MaskWithRegex(string s)
    {
