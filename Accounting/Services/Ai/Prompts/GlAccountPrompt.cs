...
8. ⛽ DECODE รายการที่เป็นรหัส/ย่อ (สำคัญ — ใบเสร็จ POS มักใช้รหัสสินค้า+ หน่วย ไม่ใช่คำเต็ม):
   ขั้นแรกต้อง ""ตีความ"" ว่ารายการคืออะไร ก่อนเลือกผัง — ใช้สัญญาณ 3 อย่าง:
   (a) VENDOR NAME — ชี้ประเภทร้านชัดสุด:
       • ""ปตท / PTT / Shell / เชลล์ / Caltex / คาลเท็กซ์ / บางจาก / Bangchak / Esso / เอสโซ่ /
         Susco / PT / พีที / สถานีบริการน้ำมัน / ปั๊ม / petrol / gas station"" → ร้านขายน้ำมัน
       • ""การไฟฟ้า / กฟภ / กฟน / MEA / PEA"" → ค่าไฟฟ้า
       • ""การประปา / กปน / กปภ"" → ค่าน้ำประปา
       • ""AIS / True / DTAC / TOT / 3BB / CAT"" → ค่าโทรศัพท์/อินเทอร์เน็ต
       • ""ทางด่วน / Easy Pass / M-Pass / การทางพิเศษ / ดอนเมืองโทลล์เวย์"" → ค่าผ่านทาง
   (b) หน่วย (UNIT) ในรายการ — บอกชนิดของสิ่งที่ซื้อ:
       • ""L / ลิตร / B/L / บาท/ลิตร"" → ของเหลววัดเป็นลิตร = น้ำมันเชื้อเพลิง (เกือบเสมอ)
       • ""kWh / หน่วย(ไฟ)"" → ค่าไฟฟ้า · ""ลบ.ม. / คิว"" → ค่าน้ำประปา
       • ""ชม. / ชั่วโมง / วัน / เดือน"" → ค่าบริการ/ค่าเช่า
   (c) รหัสสินค้าน้ำมัน (เจอบ่อยบนใบปั๊ม) — ทุกตัวนี้ = น้ำมันเชื้อเพลิง:
       • ""GSH / GSOH / แก๊สโซฮอล์ / Gasohol"" (เช่น GSH95, GSH91, GSH95S, E20, E85)
       • ""ULG / ULR / เบนซิน / Benzine / Premium / Gasoline""
       • ""HSD / ดีเซล / Diesel / B7 / B10 / B20 / Power D / EVO""
       • ""NGV / LPG / แก๊ส""
   → ทั้งหมดนี้ map เป็น ""ค่าน้ำมันเชื้อเพลิง"" (มักรหัส 5402 / 54xx / ""ค่าน้ำมัน"") ถ้ามีใน candidate_accounts.
   ⚠️ ห้ามเดาว่าน้ำมัน = ""ค่าวัสดุสิ้นเปลือง / consumable / cleaning product"" เด็ดขาด.
   ⚠️ ถ้าไม่มีผัง ""ค่าน้ำมัน"" ใน candidate → เลือกผัง expense ที่ใกล้สุด (ค่าเดินทาง/ค่าพาหนะ)
      + ใส่ compliance_flag เตือนว่าควรเปิดผัง ""ค่าน้ำมันเชื้อเพลิง"".
   ⚠️ น้ำมันรถยนต์นั่ง ≤10 ที่นั่ง = ภาษีซื้อต้องห้าม §82/5(6) → ใส่ compliance_flag เสมอ.

9. หมวดค่าใช้จ่ายไทยที่พบบ่อย (เลือกจาก candidate ที่ชื่อตรงที่สุด):
   • น้ำมัน → ค่าน้ำมันเชื้อเพลิง (5402) · ค่าไฟ → ค่าสาธารณูปโภค-ไฟฟ้า (5301)
   • ค่าน้ำประปา (5302) · ค่าโทรศัพท์/เน็ต (5303) · ค่าทางด่วน/จอดรถ → ค่าเดินทาง (5404)
   • ค่าซ่อมรถ → ค่าซ่อมแซมยานพาหนะ · ค่าขนส่ง → ค่าขนส่ง (5401)
        ...
        DateTime? documentDate = null, string? ourRole = null, bool? inputVatClaimable = null)
    {
        var payload = new
        {
            ...
            thai_context = new
            {
                rules = new[]
                {
                    "Fixed asset threshold: ≥฿50,000 + life >1 year → capitalize (นโยบายระบบ — ให้ตรงกับ rule 7; ต่ำกว่านั้นแต่เป็นเครื่องใช้ทนก็ capitalize).",
