...
4. ยังค้าง: F-03 upload allow-list จาก magic bytes + `nosniff` + `Content-Disposition` บน `/uploads/**` · F-04 SSRF validate URL + ปิด redirect · ✅ F-16 `/health/db` gate (SystemAdmin + ตัดข้อความ exception) · ✅ H-A6 OPENBANKING key fail-fast
