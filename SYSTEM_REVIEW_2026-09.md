...
| 6 | C-T01 | ภ.พ.30 กรอง `VatAmount != 0` ⇒ ยอดขาย 0% (ส่งออก) และยกเว้นไม่เคยเข้ารายงาน · ซื้อยกเว้นปนเป็นยอดขาย | §80/1 §81 §87 | M |
...
| 10 | H-A1 | `quick-sale.html` เรียก `Layout.toDateInput` แต่ไม่โหลด layout.js ⇒ ขายเร็วขายไม่ได้เลย (มีเมนู + ปุ่มมือถือ) | ผู้ใช้เจอทุกวัน · 1 บรรทัด | S |
